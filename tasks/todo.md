...
- [ ] Polish the Watch UI/UX (added 2026-09-24). Start from the known prototype smells: nav title overlaps the card, approval title repeats the verb, RootView keys status-line visibility off the "Skipped" string prefix. Keep it to prototype polish; the full M4 experience (onboarding, pairing, outcome states) stays in M4.
